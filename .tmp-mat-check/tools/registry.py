...
def _check_fn_cached(fn: Callable) -> bool:
    ...
    with _check_fn_cache_lock:
        ...
        # HERMES_OPENCLOUD_BROWSER_AVAIL_V1: permanent-missing backends
        # (e.g. Chrome not installed) must not stay advertised via grace.
        if getattr(fn, "_opencloud_no_failure_grace", False):
            pass
        else:
